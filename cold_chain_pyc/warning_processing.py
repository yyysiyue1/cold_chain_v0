...
import numpy as np # If np.nan is used, though pd.isna is more common
from sqlalchemy import text # text is used
import math
import database_setup
from database_setup import prediction_table_name, warning_table_name
from prediction_logic import replace_nan_with_none
