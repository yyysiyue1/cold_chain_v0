...
from database_setup import prediction_table_name
from tvbn_predictor import TVBNPredictor
from advanced_prediction_models import calculate_dynamic_tvbn_value
# ==============================================================================
# --- 预测逻辑函数  ---
# ==============================================================================
...
def handle_prediction_results(monitor_df, food_df, engine):
    ...
    predictor_cache = {
        'tvbn': TVBNPredictor("tvbn_predictor_model.pkl")
    }
